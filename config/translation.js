...
const aboutPageTranslation = {
  [ENGLISH]: {
    ...
    timeline8Description:
      "During the last couple, I had a great idea to enrich our young couple with another member. So our little pack has grown and now we're three. For me, it means more dog joys and worries in life.",
  },
  [CZECH]: {
    aboutDescription:
...
const mainPageTranslation = {
  [ENGLISH]: {
    ...
    homePageSection5Description:
      'I feel like a regular human being, living a normal life. I consider myself a frontend engineer based in the capital of The Czech Republic. I enjoy turning complex problems into simple, beautiful and intuitive web and mobile apps. When I\'m not programming, committing code or reading about new library features, you\'ll find me eating, playing the guitar or do some sports pieces of stuff. If you want to know more, just visit "About Page"',
    homePageSection6Heading: 'App settings',
    homePageSection6Description:
      'There are a small number of different varieties of this website. Feel free to switch the language, change the current theme. Wau there is a dark and light mode, of course. If you prefer no silence, just toggle music off. If you want to know more, just visit "Settings."',
    homePageSection7Heading: 'Current project',
    homePageSection7Description:
      'The current project we are working on is called Notify. It is a mobile application designed to make it easier for us to be together, without worrying about strange notifications or regular reminders. Notify also works on the principle of connecting more people.',
