        ...
        {/* <li className='nav-item'>
          <Link href='/cv' className={`nav-link${pathname === '/cv' ? ' active' : ''}`}>
            <svg
              ...
              xmlns='http://www.w3.org/2000/svg'
              viewBox='0 0 30 30'
              className='svg-inline--fa fa-cv fa-w-10 fa-9x'
            >
              <g className='fa-group'>
                <path
                  fill='currentColor'
                  d='M6 4h18a2 2 0 0 1 2 2v18a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z'
                  className='fa-secondary'
                ></path>
                <path
                  fill='currentColor'
                  d='M8 8h14a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H8a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1zM8 12h10a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H8a1 1 0 0 1-1-1v-1a1 1 0 0 1 1-1z'
                  className='fa-primary'
                ></path>
                <path
                  fill='currentColor'
                  d='M8 16h8a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H8a1 1 0 0 1-1-1v-1a1 1 0 0 1 1-1zM8 20h6a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1H8a1 1 0 0 1-1-1v-1a1 1 0 0 1 1-1z'
                  className='fa-primary'
                ></path>
              </g>
            </svg>
