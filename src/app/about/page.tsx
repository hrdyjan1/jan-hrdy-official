...
function AboutBlock({
  ...
  if (position === 'right') {
    return (
      <li>
        <div className='about-block-container'>
          <div className='about-block-title about-block-title-hidden'>{title}</div>
          <div className='about-block-date about-block-date-blue'>{date}</div>

          <div className='about-block-title-container-right'>
            <div className='about-block-title'>{title}</div>
          </div>
        </div>
    ...
    return (
      <li>
        <div className='about-block-container about-block-container-reverse'>
          <div className='about-block-title-container-left'>
            <div className='about-block-title about-block-title-green'>{title}</div>
          </div>

          <div className='about-block-date about-block-date-green'>{date}</div>
          <div className='about-block-title about-block-title-hidden'>{title}</div>
        </div>
      ...
      <div id='page-about-id'>
        <div id='about-container'>
          ...
          <ul className='timeline'>
            <AboutBlock
              position='right'
              title={t('timeline1Heading')}
              date={t('timeline1Date')}
              description={t('timeline1Description')}
            />
            <AboutBlock
              position='right'
              title={t('timeline2Heading')}
              date={t('timeline2Date')}
              description={t('timeline2Description')}
            />
            <AboutBlock
              position='left'
              title={t('timeline3Heading')}
              date={t('timeline3Date')}
              description={t('timeline3Description')}
            />
            <AboutBlock
              position='left'
              title={t('timeline4Heading')}
              date={t('timeline4Date')}
              description={t('timeline4Description')}
            />
            <AboutBlock
              position='left'
              title={t('timeline5Heading')}
              date={t('timeline5Date')}
              description={t('timeline5Description')}
            />
            <AboutBlock
              position='right'
              title={t('timeline6Heading')}
              date={t('timeline6Date')}
              description={t('timeline6Description')}
            />
            <AboutBlock
              position='left'
              title={t('timeline7Heading')}
              date={t('timeline7Date')}
              description={t('timeline7Description')}
            />
            <AboutBlock
              position='right'
              title={t('timeline8Heading')}
              date={t('timeline8Date')}
              description={t('timeline8Description')}
            />
            <AboutBlock
              position='left'
              title={t('timeline9Heading')}
              date={t('timeline9Date')}
              description={t('timeline9Description')}
            />
            <AboutBlock
              position='left'
              title={t('timeline10Heading')}
              date={t('timeline10Date')}
              description={t('timeline10Description')}
            />
          </ul>
          <h3>{t('contact')}</h3>
